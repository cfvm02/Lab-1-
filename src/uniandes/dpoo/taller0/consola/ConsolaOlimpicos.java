...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais que pertenence el atleta ");
	...
	private void ejecutarbuscarAtleta()
	{
		...
		String atleta = input("Por favor ingrese el nombre de un atleta");
		 ...
		 String res = calculadora.ConsultarPaisAtleta(atleta);
		
		System.out.println("El atleta pertense a " + res );
	}
